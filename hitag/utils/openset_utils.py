...
from hitag.models.hireclip import hycoclip
...
def build_openset_hycoclip_llm_label_embedding(llm_tag_des):
    print("Creating pretrained CLIP model")
    tokenizer = Tokenizer()
    model_hycoclip = hycoclip(pretrained='/path/to/hycoclip_vit_b.pth',
    ...
    with torch.no_grad():
        ...
        for item in tqdm(llm_tag_des):
            ...
            if run_on_gpu:
                ...
                model_hycoclip = model_hycoclip.cuda()
            text_embeddings = model_hycoclip.encode_text(texts, project = False)
